...
/* Generated by: scripts/ecp_comb_table.py secp192r1 */
...
#if MBEDTLS_ECP_FIXED_POINT_OPTIM == 1
/* Generated by: scripts/ecp_comb_table.py secp224r1 */
...
#if MBEDTLS_ECP_FIXED_POINT_OPTIM == 1
/* Generated by: scripts/ecp_comb_table.py secp256r1 */
...
#if MBEDTLS_ECP_FIXED_POINT_OPTIM == 1
/* Generated by: scripts/ecp_comb_table.py secp384r1 */
...
#if MBEDTLS_ECP_FIXED_POINT_OPTIM == 1
/* Generated by: scripts/ecp_comb_table.py secp521r1 */
...
#if MBEDTLS_ECP_FIXED_POINT_OPTIM == 1
/* Generated by: scripts/ecp_comb_table.py secp192k1 */
...
#if MBEDTLS_ECP_FIXED_POINT_OPTIM == 1
/* Generated by: scripts/ecp_comb_table.py secp224k1 */
...
#if MBEDTLS_ECP_FIXED_POINT_OPTIM == 1
/* Generated by: scripts/ecp_comb_table.py secp256k1 */
...
#if MBEDTLS_ECP_FIXED_POINT_OPTIM == 1
/* Generated by: scripts/ecp_comb_table.py brainpoolP256r1 */
...
#if MBEDTLS_ECP_FIXED_POINT_OPTIM == 1
/* Generated by: scripts/ecp_comb_table.py brainpoolP384r1 */
...
#if MBEDTLS_ECP_FIXED_POINT_OPTIM == 1
/* Generated by: scripts/ecp_comb_table.py brainpoolP512r1 */
...
#if MBEDTLS_ECP_FIXED_POINT_OPTIM == 1
/* Generated by: scripts/ecp_comb_table.py sm2p256v1 */
...
static const mbedtls_mpi_uint sm2p256v1_T_1_X[] = {
    BYTES_TO_T_UINT_8( 0xDD, 0x42, 0xA2, 0x95, 0xEA, 0x3B, 0xE8, 0x1F ),
    BYTES_TO_T_UINT_8( 0xEE, 0xEC, 0x47, 0x9A, 0xCC, 0x1A, 0x77, 0x8C ),
    BYTES_TO_T_UINT_8( 0x81, 0x0D, 0x2B, 0x6A, 0xBE, 0x65, 0x51, 0x62 ),
    BYTES_TO_T_UINT_8( 0x56, 0x0C, 0x2A, 0xA8, 0x7C, 0x30, 0x3C, 0xD7 ),
};
static const mbedtls_mpi_uint sm2p256v1_T_1_Y[] = {
    BYTES_TO_T_UINT_8( 0xDA, 0x65, 0xF5, 0xFD, 0x92, 0x8D, 0x68, 0x38 ),
    BYTES_TO_T_UINT_8( 0x7E, 0x4E, 0x24, 0x85, 0xDE, 0x1D, 0xDA, 0x12 ),
    BYTES_TO_T_UINT_8( 0x55, 0x4C, 0x9D, 0x5F, 0xC7, 0x91, 0xA1, 0xB6 ),
    BYTES_TO_T_UINT_8( 0x59, 0xC7, 0xB1, 0x4C, 0x2B, 0xBF, 0xE7, 0x0D ),
};
static const mbedtls_mpi_uint sm2p256v1_T_2_X[] = {
    BYTES_TO_T_UINT_8( 0x29, 0x10, 0x00, 0x45, 0x54, 0xF3, 0x59, 0xAE ),
    BYTES_TO_T_UINT_8( 0x51, 0xBB, 0x3F, 0x48, 0x96, 0xE2, 0xBF, 0xB6 ),
    BYTES_TO_T_UINT_8( 0xDC, 0x9E, 0x52, 0x19, 0x8E, 0x1B, 0x95, 0x41 ),
    BYTES_TO_T_UINT_8( 0x7F, 0xDE, 0xB1, 0x1E, 0x24, 0xE8, 0xF1, 0xDF ),
};
static const mbedtls_mpi_uint sm2p256v1_T_2_Y[] = {
    BYTES_TO_T_UINT_8( 0x35, 0x05, 0x01, 0x27, 0x88, 0xC6, 0x71, 0x85 ),
    BYTES_TO_T_UINT_8( 0xA3, 0x9C, 0x9E, 0xDE, 0xE6, 0x12, 0x43, 0x9D ),
    BYTES_TO_T_UINT_8( 0x73, 0x98, 0x5D, 0x7C, 0xC7, 0x89, 0x42, 0x05 ),
    BYTES_TO_T_UINT_8( 0xA2, 0xFD, 0xFD, 0x13, 0xFC, 0x27, 0xFB, 0x3D ),
};
static const mbedtls_mpi_uint sm2p256v1_T_3_X[] = {
    BYTES_TO_T_UINT_8( 0x72, 0x32, 0xA7, 0x8F, 0xCF, 0x87, 0x85, 0xAF ),
    BYTES_TO_T_UINT_8( 0x40, 0xDE, 0x3A, 0x06, 0x26, 0xC9, 0xEC, 0xA8 ),
    BYTES_TO_T_UINT_8( 0xF6, 0xE5, 0x4D, 0xB7, 0xD1, 0x66, 0xD9, 0x96 ),
    BYTES_TO_T_UINT_8( 0x2C, 0x1A, 0xFE, 0x4D, 0x34, 0x8B, 0x34, 0xC5 ),
};
static const mbedtls_mpi_uint sm2p256v1_T_3_Y[] = {
    BYTES_TO_T_UINT_8( 0x16, 0xE1, 0x6C, 0x68, 0xDB, 0x0D, 0xA3, 0xB0 ),
    BYTES_TO_T_UINT_8( 0x15, 0x93, 0x76, 0x6B, 0x32, 0x4F, 0xF8, 0x2B ),
    BYTES_TO_T_UINT_8( 0x80, 0x83, 0xB6, 0xB5, 0x22, 0xC7, 0xF6, 0xE8 ),
    BYTES_TO_T_UINT_8( 0xCC, 0xB4, 0xFD, 0x2E, 0xF6, 0xD3, 0x9F, 0xAA ),
};
static const mbedtls_mpi_uint sm2p256v1_T_4_X[] = {
    BYTES_TO_T_UINT_8( 0x26, 0x06, 0xC8, 0x02, 0x98, 0x20, 0x2A, 0xA9 ),
    BYTES_TO_T_UINT_8( 0xEB, 0x56, 0x75, 0xB9, 0x4B, 0xDC, 0x21, 0xA6 ),
    BYTES_TO_T_UINT_8( 0xAE, 0x09, 0x43, 0x37, 0x41, 0x74, 0x13, 0x0C ),
    BYTES_TO_T_UINT_8( 0x1C, 0x69, 0x77, 0xEC, 0xEC, 0xC5, 0x02, 0x43 ),
};
static const mbedtls_mpi_uint sm2p256v1_T_4_Y[] = {
    BYTES_TO_T_UINT_8( 0x9D, 0xDB, 0x76, 0x42, 0x4A, 0x60, 0x5A, 0x21 ),
    BYTES_TO_T_UINT_8( 0xBB, 0xDD, 0x0A, 0x36, 0x05, 0x36, 0xB8, 0xB2 ),
    BYTES_TO_T_UINT_8( 0xCB, 0x97, 0xF0, 0x41, 0x09, 0xD2, 0xF4, 0xB7 ),
    BYTES_TO_T_UINT_8( 0xA2, 0xAF, 0x18, 0xF6, 0xD9, 0xA3, 0x41, 0x2E ),
};
static const mbedtls_mpi_uint sm2p256v1_T_5_X[] = {
    BYTES_TO_T_UINT_8( 0x89, 0x17, 0xF1, 0x25, 0x3E, 0xB6, 0xFA, 0x26 ),
    BYTES_TO_T_UINT_8( 0xC2, 0x9D, 0x85, 0x38, 0x23, 0xE7, 0xE0, 0x9D ),
    BYTES_TO_T_UINT_8( 0xCF, 0xCA, 0x7B, 0xF9, 0xD2, 0xAC, 0x4D, 0x5F ),
    BYTES_TO_T_UINT_8( 0xB2, 0xEF, 0x56, 0x97, 0x61, 0xA4, 0x9A, 0x0A ),
};
static const mbedtls_mpi_uint sm2p256v1_T_5_Y[] = {
    BYTES_TO_T_UINT_8( 0x6E, 0x06, 0xF1, 0x29, 0x69, 0xE6, 0xCD, 0xC8 ),
    BYTES_TO_T_UINT_8( 0x2E, 0x17, 0x4B, 0x07, 0x30, 0xFD, 0xAB, 0x54 ),
    BYTES_TO_T_UINT_8( 0x08, 0x95, 0x43, 0xEC, 0x01, 0x47, 0xCF, 0x81 ),
    BYTES_TO_T_UINT_8( 0x9A, 0x8A, 0x4A, 0x2C, 0xF0, 0xA4, 0xC9, 0x2F ),
};
static const mbedtls_mpi_uint sm2p256v1_T_6_X[] = {
    BYTES_TO_T_UINT_8( 0xDC, 0x71, 0xF5, 0x6A, 0xB1, 0x04, 0x23, 0x1C ),
    BYTES_TO_T_UINT_8( 0xE9, 0xDF, 0x9D, 0x20, 0x1A, 0xAC, 0x3D, 0x6F ),
    BYTES_TO_T_UINT_8( 0x41, 0x59, 0xC5, 0xF7, 0xEF, 0xA5, 0xA2, 0x07 ),
    BYTES_TO_T_UINT_8( 0x4B, 0xCE, 0xF2, 0xFA, 0x6E, 0x14, 0xA7, 0x55 ),
};
static const mbedtls_mpi_uint sm2p256v1_T_6_Y[] = {
    BYTES_TO_T_UINT_8( 0x27, 0xE6, 0x3E, 0x7D, 0x5F, 0xBA, 0x09, 0x71 ),
    BYTES_TO_T_UINT_8( 0x95, 0x80, 0xE8, 0x12, 0x05, 0xB6, 0xDB, 0xC8 ),
    BYTES_TO_T_UINT_8( 0xF2, 0x8C, 0xF3, 0x7E, 0x0A, 0x68, 0xB2, 0x63 ),
    BYTES_TO_T_UINT_8( 0x7E, 0x0F, 0x53, 0x9E, 0x15, 0x28, 0x11, 0x51 ),
};
static const mbedtls_mpi_uint sm2p256v1_T_7_X[] = {
    BYTES_TO_T_UINT_8( 0xCF, 0xE4, 0x2E, 0x34, 0xAA, 0x4E, 0x42, 0xB7 ),
    BYTES_TO_T_UINT_8( 0xCF, 0x4A, 0x64, 0x7E, 0x98, 0xD9, 0x42, 0xB3 ),
    BYTES_TO_T_UINT_8( 0x17, 0xF1, 0x67, 0x5D, 0xD4, 0x31, 0xC7, 0x5C ),
    BYTES_TO_T_UINT_8( 0x5F, 0x9C, 0x80, 0xBF, 0x98, 0x08, 0xC5, 0xD5 ),
};
static const mbedtls_mpi_uint sm2p256v1_T_7_Y[] = {
    BYTES_TO_T_UINT_8( 0x16, 0x3C, 0x4A, 0x31, 0xD1, 0x19, 0xCB, 0xF1 ),
    BYTES_TO_T_UINT_8( 0xC8, 0x4D, 0xB0, 0x64, 0xDE, 0x46, 0xE3, 0x49 ),
    BYTES_TO_T_UINT_8( 0xBC, 0x30, 0x3D, 0x78, 0xD6, 0xD3, 0xA0, 0x43 ),
    BYTES_TO_T_UINT_8( 0xB5, 0x28, 0x00, 0x8C, 0x51, 0x52, 0x58, 0x9A ),
};
static const mbedtls_mpi_uint sm2p256v1_T_8_X[] = {
    BYTES_TO_T_UINT_8( 0xD7, 0xE4, 0x37, 0x09, 0x04, 0x81, 0x15, 0x26 ),
    BYTES_TO_T_UINT_8( 0xC6, 0x3D, 0xAE, 0x5E, 0xB8, 0x06, 0xC3, 0xA5 ),
    BYTES_TO_T_UINT_8( 0xF2, 0xC9, 0x1A, 0xDA, 0x03, 0xE7, 0x00, 0x91 ),
    BYTES_TO_T_UINT_8( 0x25, 0x3C, 0xAE, 0x52, 0x34, 0xBE, 0xB0, 0xEE ),
};
static const mbedtls_mpi_uint sm2p256v1_T_8_Y[] = {
    BYTES_TO_T_UINT_8( 0xD2, 0x7C, 0x03, 0xCD, 0xCB, 0x27, 0x28, 0xAF ),
    BYTES_TO_T_UINT_8( 0x8E, 0xAB, 0x12, 0xB2, 0x00, 0xCC, 0xAD, 0x43 ),
    BYTES_TO_T_UINT_8( 0x82, 0x62, 0x80, 0xE8, 0xFB, 0x88, 0x7D, 0x85 ),
    BYTES_TO_T_UINT_8( 0xCF, 0xFF, 0xBC, 0x5D, 0x7C, 0xC8, 0xB1, 0xBC ),
};
static const mbedtls_mpi_uint sm2p256v1_T_9_X[] = {
    BYTES_TO_T_UINT_8( 0xD3, 0xCB, 0xDC, 0xE9, 0x8B, 0x0C, 0x9E, 0xBF ),
    BYTES_TO_T_UINT_8( 0x46, 0x47, 0x63, 0x4E, 0x25, 0x6C, 0x73, 0x5E ),
    BYTES_TO_T_UINT_8( 0xEA, 0x72, 0x77, 0xAC, 0x0A, 0x8C, 0x03, 0x4C ),
    BYTES_TO_T_UINT_8( 0x6E, 0xEF, 0x4B, 0xB4, 0xD6, 0x09, 0xFC, 0xFE ),
};
static const mbedtls_mpi_uint sm2p256v1_T_9_Y[] = {
    BYTES_TO_T_UINT_8( 0xC8, 0x10, 0xBE, 0x34, 0xC3, 0x7F, 0x05, 0x51 ),
    BYTES_TO_T_UINT_8( 0x70, 0x69, 0x15, 0x89, 0x3D, 0xCF, 0xFA, 0x74 ),
    BYTES_TO_T_UINT_8( 0x3D, 0x0B, 0x2F, 0x35, 0x3A, 0x4E, 0xE7, 0xFD ),
    BYTES_TO_T_UINT_8( 0x76, 0xA6, 0x47, 0x01, 0x42, 0x27, 0x89, 0x43 ),
};
static const mbedtls_mpi_uint sm2p256v1_T_10_X[] = {
    BYTES_TO_T_UINT_8( 0x40, 0x05, 0xFB, 0x17, 0x39, 0xEA, 0x4C, 0xB3 ),
    BYTES_TO_T_UINT_8( 0x38, 0xFB, 0xE0, 0x31, 0x7E, 0x58, 0x11, 0xF7 ),
    BYTES_TO_T_UINT_8( 0xEC, 0x62, 0x78, 0x15, 0xB0, 0x46, 0x22, 0x1B ),
    BYTES_TO_T_UINT_8( 0xA5, 0x45, 0xC9, 0x0C, 0x94, 0xF4, 0x3F, 0x13 ),
};
static const mbedtls_mpi_uint sm2p256v1_T_10_Y[] = {
    BYTES_TO_T_UINT_8( 0x97, 0x58, 0x40, 0x52, 0x96, 0xA1, 0xB5, 0xA7 ),
    BYTES_TO_T_UINT_8( 0x10, 0xB9, 0xF5, 0x6F, 0xFF, 0x5D, 0xD5, 0x71 ),
    BYTES_TO_T_UINT_8( 0xE7, 0x11, 0x96, 0xF0, 0x38, 0x8A, 0x18, 0xF4 ),
    BYTES_TO_T_UINT_8( 0x62, 0xD7, 0x9E, 0x63, 0x02, 0x10, 0xEB, 0xA9 ),
};
static const mbedtls_mpi_uint sm2p256v1_T_11_X[] = {
    BYTES_TO_T_UINT_8( 0x15, 0xC5, 0xED, 0x5A, 0xC3, 0x65, 0x61, 0x9B ),
    BYTES_TO_T_UINT_8( 0x9A, 0x3A, 0x9C, 0xAD, 0x5E, 0x59, 0xD1, 0x74 ),
    BYTES_TO_T_UINT_8( 0xB1, 0x92, 0x04, 0xD9, 0x24, 0x58, 0xF5, 0xC0 ),
    BYTES_TO_T_UINT_8( 0xE0, 0xEE, 0xAE, 0xD1, 0x3D, 0x08, 0xA8, 0xB7 ),
};
static const mbedtls_mpi_uint sm2p256v1_T_11_Y[] = {
    BYTES_TO_T_UINT_8( 0x79, 0x16, 0x5E, 0x1A, 0x27, 0x47, 0xA5, 0x72 ),
    BYTES_TO_T_UINT_8( 0xA6, 0x71, 0xFD, 0x3C, 0x8B, 0x7A, 0xED, 0xC5 ),
    BYTES_TO_T_UINT_8( 0xB0, 0xA6, 0x49, 0x2B, 0xC5, 0x30, 0xB6, 0xDE ),
    BYTES_TO_T_UINT_8( 0x2F, 0x19, 0x99, 0x7D, 0xF3, 0xDA, 0x2F, 0x39 ),
};
static const mbedtls_mpi_uint sm2p256v1_T_12_X[] = {
    BYTES_TO_T_UINT_8( 0x4F, 0xF5, 0xA0, 0x08, 0x02, 0x1B, 0xF0, 0x7D ),
    BYTES_TO_T_UINT_8( 0xE1, 0x10, 0xD3, 0x71, 0xC8, 0x5B, 0x51, 0x0D ),
    BYTES_TO_T_UINT_8( 0xE3, 0x45, 0xA9, 0x3B, 0x50, 0x2C, 0x93, 0x51 ),
    BYTES_TO_T_UINT_8( 0x1A, 0xEF, 0x6C, 0xB5, 0x95, 0x00, 0x6F, 0x62 ),
};
static const mbedtls_mpi_uint sm2p256v1_T_12_Y[] = {
    BYTES_TO_T_UINT_8( 0x14, 0xAA, 0x3E, 0x30, 0xF0, 0x0B, 0x5F, 0x99 ),
    BYTES_TO_T_UINT_8( 0x98, 0xA4, 0x9B, 0xF9, 0x59, 0x85, 0xAC, 0x20 ),
    BYTES_TO_T_UINT_8( 0xC0, 0x71, 0x6E, 0x7E, 0x94, 0xD7, 0x31, 0x67 ),
    BYTES_TO_T_UINT_8( 0xE5, 0xBE, 0x47, 0x14, 0x13, 0x68, 0xCF, 0x7D ),
};
static const mbedtls_mpi_uint sm2p256v1_T_13_X[] = {
    BYTES_TO_T_UINT_8( 0xE9, 0xF5, 0x5D, 0x18, 0xEA, 0x45, 0x98, 0x5D ),
    BYTES_TO_T_UINT_8( 0xD9, 0x00, 0x28, 0xCC, 0x4A, 0xCC, 0xFB, 0x5D ),
    BYTES_TO_T_UINT_8( 0xA9, 0x66, 0x35, 0xC8, 0xE4, 0x5A, 0x0D, 0x09 ),
    BYTES_TO_T_UINT_8( 0xEF, 0x1E, 0x71, 0x22, 0x36, 0x86, 0x30, 0x39 ),
};
static const mbedtls_mpi_uint sm2p256v1_T_13_Y[] = {
    BYTES_TO_T_UINT_8( 0x62, 0x20, 0xF9, 0x6B, 0x4B, 0xF3, 0x52, 0xFD ),
    BYTES_TO_T_UINT_8( 0xDB, 0x8B, 0xA8, 0x89, 0x60, 0x19, 0xE1, 0x3E ),
    BYTES_TO_T_UINT_8( 0xAA, 0x0C, 0xFF, 0x0E, 0xC9, 0x78, 0x83, 0x40 ),
    BYTES_TO_T_UINT_8( 0x0D, 0x07, 0x4F, 0xF8, 0x93, 0xFB, 0xBC, 0x19 ),
};
static const mbedtls_mpi_uint sm2p256v1_T_14_X[] = {
    BYTES_TO_T_UINT_8( 0x24, 0x53, 0x7F, 0x57, 0x83, 0x72, 0x3B, 0x01 ),
    BYTES_TO_T_UINT_8( 0xD9, 0x53, 0x3D, 0xBB, 0xF0, 0xB5, 0x10, 0x86 ),
    BYTES_TO_T_UINT_8( 0x68, 0x05, 0xA2, 0x68, 0x28, 0xFB, 0xE0, 0x26 ),
    BYTES_TO_T_UINT_8( 0xBE, 0x3A, 0x74, 0x63, 0x62, 0x10, 0x8B, 0x81 ),
};
static const mbedtls_mpi_uint sm2p256v1_T_14_Y[] = {
    BYTES_TO_T_UINT_8( 0xA6, 0x53, 0x14, 0x64, 0x4F, 0x94, 0x44, 0x47 ),
    BYTES_TO_T_UINT_8( 0x06, 0x17, 0xB5, 0xDA, 0xD3, 0xD7, 0x4F, 0x01 ),
    BYTES_TO_T_UINT_8( 0x74, 0x46, 0x50, 0xE6, 0x07, 0x21, 0x7B, 0xC5 ),
    BYTES_TO_T_UINT_8( 0xF2, 0xE0, 0x37, 0x6D, 0x85, 0x46, 0x7F, 0xF1 ),
};
static const mbedtls_mpi_uint sm2p256v1_T_15_X[] = {
    BYTES_TO_T_UINT_8( 0xD5, 0xF2, 0x1C, 0xDF, 0x44, 0x5B, 0x6F, 0x40 ),
    BYTES_TO_T_UINT_8( 0xC8, 0x46, 0xE6, 0x82, 0x42, 0x0C, 0x4B, 0x8E ),
    BYTES_TO_T_UINT_8( 0xEC, 0x16, 0x7B, 0xEF, 0xE5, 0x21, 0x32, 0x89 ),
    BYTES_TO_T_UINT_8( 0x3F, 0xE9, 0x76, 0xAE, 0xBE, 0x89, 0x23, 0x28 ),
};
static const mbedtls_mpi_uint sm2p256v1_T_15_Y[] = {
    BYTES_TO_T_UINT_8( 0x06, 0xA4, 0x0C, 0x1D, 0xBC, 0xFD, 0x23, 0xCC ),
    BYTES_TO_T_UINT_8( 0xA8, 0xB4, 0xDF, 0x0A, 0x35, 0xE9, 0xC7, 0x1C ),
    BYTES_TO_T_UINT_8( 0xC9, 0xEA, 0x09, 0x3C, 0x81, 0x24, 0x4F, 0xE1 ),
    BYTES_TO_T_UINT_8( 0xB7, 0x14, 0x0E, 0x71, 0xEA, 0x2E, 0x03, 0xC9 ),
};
